...
coins = [('bitcoin', 14446.100, 50), ('ethereum', 719.441, 50),
         ('bitcoin-cash', 2609.576, 50), ('iota', 3.412, 100),
         ('dash', 1101.123, 30), ('monero', 373.981, 100), ('qtum', 53.074, 50),
         ('stellar', 0.201844, 50), ('zcash', 508.914, 30),
         ('raiblocks', 10.7311, 100), ('omisego', 13.495, 30),
         ('waves', 12.353, 20), ('populous', 30.229, 30), ('salt', 13.756, 20),
         ('decred', 88.273, 30), ('maidsafecoin', 0.920078, 40)]
